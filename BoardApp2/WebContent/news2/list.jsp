...
<%
	...
	int pageSize=10;//페이지 당 보여질 레코드 수(개발자가 임의로 지정가능)
	...
	int firstPage=currentPage-(currentPage-1)%blockSize;//첫페이지
...
<body>
	<table>
		...
		<tr onMouseOver="showColor(this)" onMouseout="hideColor(this)"><!-- this는 tr -->
			<td><%=num--%></td>
			<td>
