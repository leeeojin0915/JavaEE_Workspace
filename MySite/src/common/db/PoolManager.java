/*
 * 커넥션 풀 사용을 보다 편하게 처리해야 DAO들에서 고생 안한다.
 * */
package common.db;
...
public class PoolManager {
	...
	//하지만 클래스는 쓰라고 만든것이기에 인스턴스를 가져갈 기회를 현재 클래스에 ㅜㅂ담해주자
	public static PoolManager getInstace() {
		if(instance==null) {
			instance=new PoolManager();//오직 나만이 new 할 수 있다.
		}
		return instance;
	}
	//커넥션이 필요한 자에게 Connection을 반환해주는 (대여)메소드
