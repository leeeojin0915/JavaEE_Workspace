...
<%
	...
	//자바기반의 웹어플리케이션은 어떤 OS건 중립적 실행이 보장되어야 하므로, 특정 시스템에 의존하는 경로를 사용해서는 안된다
	...
	//스스로 알아낼 수 있다.
	String realPath=application.getRealPath("/data");//웹사이트의 루트를 기준으로 특정 파일이나,디렉토리를 명시하면 스스로 현재 실행중인 웹사이트가 얹혀진 OS로부터 풀경로를 구해온다.
	//out.print(realPath);
