...
public class PropTest {
	public PropTest() {
		...
		try {
			fis=new FileInputStream("D:/koreaIT/Workspace/javaEE_workspace/MVCFramework/WebContent/WEB-INF/mapping/mapping.properties");
			props.load(fis);//프로퍼티스 객체와 스트림연결
